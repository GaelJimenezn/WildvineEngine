...
public:
    ...
    GUI() = default;
    /** @brief Does not automatically shut down ImGui; call destroy() in application shutdown. */
    ~GUI() = default;
    ...
    /** @brief Starts a frame and builds the editor UI for the current viewport/window state. */
