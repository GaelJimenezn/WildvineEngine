...
public:
   ...
   * @return S_OK en Ã©xito.
   */
  HRESULT
  init(Device &device, RendererType initialRenderer = RendererType::Deferred);

  /**
   * @brief Cambia el renderer activo en tiempo de ejecuciÃ³n.
   ...
   * @param camera        CÃ¡mara del editor.
   ...
   * @param enabled true para activar la visualizaciÃ³n de shadow factor.
   */
