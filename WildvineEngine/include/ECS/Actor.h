...
private:
  ...
  /** @brief Buffers de vértices asociados a las mallas.. */
  std::vector<Buffer> m_vertexBuffers;
  /** @brief Buffers de índices asociados a las mallas.. */
  std::vector<Buffer> m_indexBuffers;

  //BlendState m_blendState;                // Estado de blending usado por el actor.
  //RasterizerState m_rasterizer;
  // Estado de rasterización usado por el actor.
  ...
  /** @brief Posición de la luz para proyección de sombras.. */
  XMFLOAT4 m_LightPos;
