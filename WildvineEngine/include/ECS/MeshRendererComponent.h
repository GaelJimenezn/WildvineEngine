 ...
 *
 * @note This class does not create or destroy GPU resources; referenced assets are owned
 * elsewhere.
 */
class
...
public:
	 ...
	 * @param materialInstances Non-owning material instance pointers ordered by material
	 * slot.
	 */
	void
