...
/**
 * @brief DeclaraciÃ³n adelantada de la clase Window.
 */
class Window;
...
public:
   ...
   * @param width Ancho del Ã¡rea de renderizado.
   * @param height Alto del Ã¡rea de renderizado.
   * @return HRESULT que indica el resultado de la operaciÃ³n.
   */
  HRESULT
  ...
  /**
   * @brief Actualiza los parÃ¡metros del viewport si es necesario.
   */
  void update();
...
public:
  /** @brief Estructura que almacena la configuraciÃ³n del viewport de Direct3D. */
