...
private:
     ...
     * para el flujo del usuario: importacion, modelos, texturas, escena y prefabs.
     */
    static bool
    shouldStore(LogLevel level, const std::string& msg) {
        ...
        return contains(lower, "import") ||
            contains(lower, "model") ||
            contains(lower, "modelo") ||
            contains(lower, "texture") ||
            contains(lower, "textura") ||
            contains(lower, "thumbnail") ||
            contains(lower, "scene") ||
            contains(lower, "escena") ||
            contains(lower, "prefab") ||
            contains(lower, "binary cache") ||
