...
/**
 * @class ShaderProgram
 * @brief Encapsula la creación, compilación y uso de Vertex Shader y Pixel Shader en
 * Direct3D 11.
 *
...
public:
    ...
    /**
     * @brief Crea un shader (Vertex o Pixel) a partir del archivo establecido en @c
     * m_shaderFileName.
     *
     * @param device Dispositivo con el que se creará el recurso.
