...
/**
 * @class Device
 * @brief Encapsula un @c ID3D11Device y facilita la creación de recursos gráficos en
 * Direct3D 11.
 *
...
public:
   ...
   * @param pDesc     Descriptor de la RTV (puede ser @c nullptr para usar valores por
   * defecto).
