/**
 * @file SceneGraph.h
 * @brief Declara la API de SceneGraph para la jerarquÃ­a de escena.
 */
#pragma once
...
/**
 * @class SceneGraph
 * @brief Grafo de escena jerÃ¡rquico del motor.
 *
 * El SceneGraph administra la relaciÃ³n padre-hijo entre entidades,
 * permite la propagaciÃ³n de transformaciones y controla la actualizaciÃ³n
 * y renderizado jerÃ¡rquico de la escena.
 */
class SceneGraph {
public:
  /**
   ...
   */
  void addEntity(Entity *e); // registra en el grafo
   ...
   *
   * @param child Entidad que serÃ¡ hija.
   * @param parent Entidad que serÃ¡ el padre.
   ...
   *
   * Propaga transformaciones y ejecuta la lÃ³gica de actualizaciÃ³n
   ...
   *
   * El render se realiza respetando la jerarquÃ­a del grafo.
   *
...
private:
  ...
  /**
   * @brief Comprueba si una entidad es raÃ­z del grafo.
   *
  ...
  /**
   * @brief Comprueba si una entidad estÃ¡ registrada en el grafo.
   *
   * @param e Entidad a comprobar.
   * @return true si la entidad estÃ¡ registrada.
   */
