...
/**
 * @file SamplerState.h
 * @brief Declaración de la clase SamplerState, encargada de administrar el estado del
 ...
 *
 * Esta clase maneja el objeto ID3D11SamplerState que define cómo se muestrean las
 * texturas
...
public:
   ...
   *
   * @param deviceContext Referencia al contexto del dispositivo donde se aplicará el
   * sampler.
